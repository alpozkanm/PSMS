                        ...
                        <div class="mdl-card__supporting-text">
                            ...
                            <c:if test="${stuff != null}">
                                ...
                                <div class="mdl-textfield mdl-js-textfield">
                                    <input class="mdl-textfield__input" type="text" name="name" value="<c:out value='${stuff.name}'/>" id="name" />
                                    <label class="mdl-textfield_label" for="name">Name</label>
                                </div>

                                <div class="mdl-textfield mdl-js-textfield">
                                    <input class="mdl-textfield__input" type="text" name="description" value="<c:out value='${stuff.description}' />" id="description" />
                                ...
                                <div class="mdl-textfield mdl-js-textfield">
                                    <input class="mdl-textfield__input" type="text" name="location" value="<c:out value='${stuff.location}'/>" id="location" />
                                    <label class="mdl-textfield__label" for="location">Luantity</label>
